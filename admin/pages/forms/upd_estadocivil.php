    ...
    if (isset($_POST['submit'])) {
        ...
        $str = "UPDATE estadocivil SET estcivil='" . ucfirst($estado) . "', idestatus='" . $estatus . "' 
          WHERE idestcivil = '" . $idec . "'";
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="<?php echo $roww['estcivil']; ?>" name="estado" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
