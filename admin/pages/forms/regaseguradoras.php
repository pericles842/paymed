<?php
	...
	if(isset($_POST['submit'])){
		/*Asigno variables*/
    $codigo = $_POST['codigo'];
		$nombre1 = $_POST['nombreaseguradora'];
    $ramo =$_POST['ramo'];
    $fecharegistro = $_POST['fecharegistro'];
		$estatus = $_POST['estatus'];

		//echo $categoria.'--'.$describelo; exit();
		$str="INSERT INTO aseguradoras(codigo,nombre,ramos,estatus,fecreg) VALUES ('".$codigo."','".$nombre1."','".$estatus."','".$fecharegistro."')";
        ...
        <div class="col-md-12"-->
          <div class="card card-primary">
			...
			<div class="col-md-6">
              <div class="form-group">
                <label for="inputName">Nombre de aseguradora</label>
                <input type="text" value=""  name="nombreaseguradora" class="form-control">
              </div>
              <div class="form-group">
                <label for="inputName">Ramo</label>
                <input type="text" value=""  name="ramo" class="form-control">
              </div>
			</div>
			<div class="col-md-6">
		     <div class="form-group">
          ...
          <div style="display:flex;">
            <div class="form-group " >
              ...
              <div class="form-group">
                <label for="inputName">Fecha de registro</label>
                <input type="date" value=""  name="fecharegistro" class="form-control">
              </div>
          </div>
			</div> 
