        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Registro Datos Personales</h1>
                        </div>
                        <div class="col-sm-6">
	        ...
	        <div class="col-md-12"-->
                <div class="card card-primary">
                    <div style="background: #F89921" class="card-header">
                        <h3 class="card-title">Datos a Completar</h3>
                        ...
                        <form enctype="multipart/form-data" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group d-flex ">
                                        <div class="w-25">
                                            <select id="select" readonly name="nacionalidad" require class=" form-control custom-select">
                                                <option value="V">V</option>
                                                <option value="E">E</option>
                                            </select>
                                        </div>
                                        <div>
                                            <input onchange="validateDocument(this.value)" require type="number" class="form-control" name="nroDocumento">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <input type="text"  require class="form-control" name="nameUno">
                                </div>
                                <div class="col-md-3">
                                    <label for="inputName">Segundo nombre</label>
                                    <input type="text"  require class="form-control" name="nameDos">
                                </div>
                                <div class="col-md-3">
                                    <label for="inputName">Primer apellido</label>
                                    <input type="text"  require class="form-control" name="lastNameUno">
                                </div>
                                <div class="col-md-3">
                                    <label for="inputName">Segundo apellido</label>
                                    <input type="text" require class="form-control" name="lastNameDos">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        <select name="pais" require class="form-control custom-select">
                                            <?php
                                ...
                                <div class="col-md-3 d-flex">
                                    <div>
                                        ...
                                        <input require id="fechaNacimiento" type="date" class="form-control " min="1930-01-01" name="dateBirth">
                                    </div>
                                    <div>
                                        <label for="inputName">Edad</label>
                                        <input require id="edad" readonly type="number" class="form-control" name="edad">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <label for="inputName">Sexo</label>
                                    <div class="form-group">
                                        <select require name="sexo" class="form-control custom-select">
                                            <?php
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        <select  require name="edoCivil" class="form-control custom-select">
                                            <?php
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <input require onchange="validationTel(this.value)" type="number" name="nroMovil" class="form-control">
                                </div>
                                <div class="col-md-3">
                                    <div>
                                        <label for="inputName">Telefono Hab</label>
                                        <input require onchange="validationTel(this.value)" type="number" name="telefono" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" require name="ocupacion" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <input type="text" require name="calle" class="form-control">
                                </div>
                                <div class="col-md-3">
                                    <label for="inputName">Casa/Edfi</label>
                                    <input type="text" require name="casa" class="form-control">
                                </div>
                                <div class="col-md-3">
                                    <label for="inputName">Piso</label>
                                    <input type="text" require name="piso" class="form-control">
                                </div>
                                <div class="col-md-3">
                                    <label for="inputName">Apto</label>
                                    <input type="text" require name="apto" class="form-control">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3">
                                    <label for="inputName">Urbanización</label>
                                    <input type="text" require name="urbanizacion" class="form-control">
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        <select require name="municipio" class="form-control custom-select">
                                            <?php
                                ...
                                <div class="col-md-3 d-flex">
                                    <div>
                                        ...
                                        <div class="form-group">
                                            <select require name="ciudad" class="form-control custom-select">
                                                <?php
                                                $getmpo = ("SELECT * FROM municipio");
                                                $getmpo2 = $mysqli->query($getmpo);
                                                while ($row = mysqli_fetch_array($getmpo2)) {
                                    ...
                                    <div>
                                        ...
                                        <input require type="number" class="form-control  " name="codPostal">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <select require name="seguro" class="form-control custom-select">
                                            <option value="dato1">Dato 1</option>
                                            <option value="dato2">Dato 2</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="number" require class="form-control" name="nroPoliza">
                                </div>
                            </div>
                            <div class="row">
