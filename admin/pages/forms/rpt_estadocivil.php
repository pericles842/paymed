                ...
                <?php while ($row = mysqli_fetch_array($result)) { ?>
                  <tr>
                    ...
                    <td class="project-actions text-right">
                      <a class="btn btn-info btn-sm" href="upd_estadocivil.php?idec=<?php echo $row['idestcivil']; ?>"><i class="fas fa-pencil-alt"></i> Editar</a>
                      <a class="btn btn-danger btn-sm" href="src_del_estadocivil.php?idec=<?php echo $row['idestcivil']; ?>"><i class="fas fa-trash"></i> Eliminar</a>
                    </td>
