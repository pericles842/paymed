  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Listado de Servicios Afiliados</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../../index.php?usr=1">Home</a></li>
              <li class="breadcrumb-item active">Listado de Servicios Afiliados</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
  ...
  <section class="content">
			<div align="center" class="col-md-12">
				<!--form action="reguser.php" method="POST"-->
					...
					<boton class="buttonr"><a style="color: #FFFFFF;font-family: 'Lato', sans-serif;font-size: 18px;font-weight: bold;" href="regservafafiliados.php">Añadir</a></boton>
				<!--/form-->
			</div><br>
      <!-- Default box -->
      <div class="card">
        <div style="background: #F89921"  class="card-header">
          <h3 class="card-title">Servicios Afiliados</h3>
              ...
              <tbody>
                  ...
                  <tr>
                      ...
                      <td class="project-actions text-right">
						            <a class="btn btn-info btn-sm" href="upd_servafafiliados.php?idservi=<?php echo $row['idservaf'];?>"><i class="fas fa-pencil-alt"></i> Editar</a>
                        <a class="btn btn-danger btn-sm" href="src_del_servafafiliados.php?idservi=<?php echo $row['idservaf'];?>"><i class="fas fa-trash"></i> Eliminar</a>
                      </td>
