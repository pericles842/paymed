            ...
            <section class="content">
                ...
                <div class="card">
                    <div style="background: #F89921" class="card-header">
                        <h3 class="card-title">Terminos y Condiciones</h3>
                            ...
                            <tbody>
                                <?php while ($row = mysqli_fetch_array($result)) { ?>
                                    <tr>
                                        ...
                                        <td class="project-actions text-left" style="display:flex;" >
                                            <a class="btn btn-info btn-sm" href="upd_terminos.php?idter=<?php echo $row['idterminos']; ?>"><i class="fas fa-pencil-alt"></i> Editar</a>
                                        </td>
