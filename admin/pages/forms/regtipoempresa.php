<?php
	...
	if(isset($_POST['submit'])){
		...
		$str="INSERT INTO tipoempresa(tipoempresa,idestatus) VALUES ('".$tipoempresa."','".$estatus."')";
		$conexion=$mysqli->query($str);
		
		echo '<script language="javascript">alert("Registro Exitoso !!!");window.location.href="rpt_tipoempresa.php"; </script>';
	}	
?>
<!DOCTYPE html>
<html>
