<?php
  ...
  $sql = ("SELECT * FROM frecuenciapago WHERE idfq = '".$idfrecuencia."'");
    ...
    $idfrecuencia= $_POST['idfrecuencia'];
		...
		$str="UPDATE frecuenciapago SET frecuencia='".ucfirst($frecuencia)."', idestatus='".$estatus."' 
          WHERE idfq = '".$idfrecuencia."'";
		  $conexion=$mysqli->query($str);
		
		echo '<script language="javascript">alert("Actualizacion Exitosa!!!");
                                        window.location.href="rpt_frecuencia.php"; </script>';
	}	
?>
<!DOCTYPE html>
<html>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Actualizacion Frecuencia de Pagos</h1>
          </div>
          <div class="col-sm-6">  
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../../index.php?usr=1">Home</a></li>
              <li class="breadcrumb-item active">Actualizacion Frecuencia de Pagos</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="col-md-12"-->
          <div class="card card-primary">
            <div style="background: #F89921"  class="card-header">
              <h3 class="card-title">Actualizacion Frecuencia de Pagos</h3>
			...
			<div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" value="<?php echo $roww['frecuencia'];?>"  name="frecuencia" class="form-control">
              </div>
			</div>
			<div class="col-md-6">
			  <div class="form-group">
