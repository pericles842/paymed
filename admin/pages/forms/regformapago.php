...
if (isset($_POST['submit'])) {
    ...
    $str = "INSERT INTO formpago(forma,detalle,moneda,comision,idestatus) VALUES ('".ucfirst($formapago)."',
    '".$detalle."','".$moneda."','".$comision."','".$estatus."')";
    $conexion = $mysqli->query($str);
    
    
    //echo $str;exit();
    echo '<script language="javascript">alert(" Registro Exitoso !!!");window.location.href="rpt_formapago.php"; </script>';
}
?>
<!DOCTYPE html>
<html>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Registro Formas de Pago</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
	        ...
	        <div class="col-md-12"-->
                <div class="card card-primary">
                    <div style="background: #F89921" class="card-header">
                        <h3 class="card-title">Registro Formas de Pago</h3>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <input class="form-control" type="text" name="formapago">
                                    </div>
                                    <div class="mb-4">
