      ...
      <div class="content-wrapper">
         ...
         <section class="content">
            <div align="center" class="col-md-12">
               ...
               <boton class="buttonr"><a style="color: #FFFFFF;font-family: 'Lato', sans-serif;font-size: 18px;font-weight: bold;" href="regtipoempresa.php">Añadir</a></boton>
               <!--/form-->
            </div><br>
            <!-- Default box -->
            <div class="card">
               <div style="background: #F89921" class="card-header">
                  <h3 class="card-title">Asesor de Empresa</h3>
                        ...
                        <?php while ($row = mysqli_fetch_array($result)) { ?>
                           <tr>
                              ...
                              <td class="project-actions text-right">
                                 <a class="btn btn-info btn-sm" href="upd_tipoempresa.php?idtp=<?php echo $row['idtipoempresa']; ?>"><i class="fas fa-pencil-alt"></i> Editar</a>
                                 <a class="btn btn-danger btn-sm" href="src_del_tipoempresa.php?idtp=<?php echo $row['idtipoempresa']; ?>"><i class="fas fa-trash"></i> Eliminar</a>
                              </td>
