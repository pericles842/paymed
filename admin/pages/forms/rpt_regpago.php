...
$sqlpago = ("SELECT a.*, b.idmed, b.nombre1, b.correo FROM regpagos a, medicos b WHERE a.idmed=b.idmed;");
            ...
            <section class="content">
                ...
                <div class="card">
                    <div style="background: #F89921" class="card-header">
                        <h3 class="card-title">Pagos por Apropar</h3>
                            ...
                            <tbody>
                                <?php while ($row = mysqli_fetch_array($resultpago)) { ?>
                                    <tr>
                                        ...
                                        <td><?php echo $row['bnco']?></td>
                                        <td><?php echo $row['monto']?></td>
                                        <td class="project-actions text-right">
                                            <a class="btn btn-info btn-sm" href="#?idsex=<?php echo $row['idpagos']; ?>"><i class="fas fa-pencil-alt"></i> Apropobar</a>
                                            <a class="btn btn-danger btn-sm" href="#?idsex=<?php echo $row['idpagos']; ?>"><i class="fas fa-trash"></i>Rechazar</a>
                                        </td>
