...
$idbc = $_GET['idbc'];
$sql = ("SELECT * FROM bancos WHERE idbco = '" . $idbc . "'");
...
if (isset($_POST['submit'])) {
    ...
    $str = "UPDATE bancos SET banco='" . ucfirst($banco) . "',idtipo='" . $tipo. "',
     idestatus='" . $estatus . "' WHERE idbco = '" . $idbc . "'";
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Actualizacion Bancos</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="../../index.php?usr=1">Home</a></li>
                                <li class="breadcrumb-item active">Actualizacion Bancos</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
        ...
        <div class="col-md-12"-->
                <div class="card card-primary">
                    <div style="background: #F89921" class="card-header">
                        <h3 class="card-title">Actualizacion Bancos</h3>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" value="<?php echo $idbc; ?>" name="idbc">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control custom-select" name="tipo" required>
                                            <option value="<?php echo $roww['idtipo']; ?>" selected>
                                            <?php
                                            $sqlbnco = ("SELECT tipo FROM tipobanco WHERE idtipo ='".$roww['idtipo']."'"    );
                                            $respst = $mysqli->query($sqlbnco);
                                            $rowst = mysqli_fetch_array($respst);
                                            echo $rowst['tipo']; ?></option>
