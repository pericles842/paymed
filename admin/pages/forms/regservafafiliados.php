<?php
	...
	if(isset($_POST['submit'])){
		...
		$str="INSERT INTO serviciosafiliados(servicio,idestatus) VALUES ('".$servicios."','".$estatus."')";
		$conexion=$mysqli->query($str);
		
		echo '<script language="javascript">alert("Registro Exitoso !!!");window.location.href="rpt_servafafiliados.php"; </script>';
	}	
?>
<!DOCTYPE html>
<html>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1> Registro de Servicios Afiliados</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../../index.php?usr=1">Home</a></li>
              <li class="breadcrumb-item active">Registro de Servicios Afiliados</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
