...
$sql = ("SELECT * FROM especialidadmed");
                ...
                <?php while ($row = mysqli_fetch_array($result)) { ?>
                  <tr>
                    ...
                    <td class="project-actions text-right">
                      <a class="btn btn-info btn-sm" href="upd_espmed.php?idespm=<?php echo $row['idespmed']; ?>"><i class="fas fa-pencil-alt"></i> Editar</a>
                      <a class="btn btn-danger btn-sm" href="src_del_espmed.php?idespm=<?php echo $row['idespmed']; ?>"><i class="fas fa-trash"></i> Eliminar</a>
                    </td>
