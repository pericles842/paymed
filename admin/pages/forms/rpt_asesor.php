<?php
	...
	$sql = ("SELECT * FROM asesor where estatus='A' ");
  ...
  <section class="content">
			<div align="center" class="col-md-12">
				<!--form action="reguser.php" method="POST"-->
					...
					<boton class="buttonr"><a style="color: #FFFFFF;font-family: 'Lato', sans-serif;font-size: 18px;font-weight: bold;" href="regasesor.php">Añadir</a></boton>
				<!--/form-->
			</div><br>
      <!-- Default box -->
      <div class="card">
          ...
          <table class="table table-striped projects">
              ...
              <tbody>
				  <?php
					...
					//$id_usuario=base64_encode($row['idproduct']);
					//echo $row['apellido1'];exit();
					//$ruta="img/".$row['imagen'];
					//echo $ruta;  exit();
					?>
                  <tr>
                      <td><?php echo $row['idasesor']; ?></td>
                      <td><ul class="list-inline"><li class="list-inline-item"><img alt="Avatar" class="table-avatar" src="img/<?php echo $row['imagen'];?>"></li></ul></td>
					  <!--td><ul class="list-inline"><li class="list-inline-item"><img alt="Avatar" class="table-avatar" src="img/pedro.png"></li></ul></td-->
					  <td><a><?php echo $row['apellido1'].' '.$row['apellido2']; ?></a>, <a><?php echo $row['nombre1'].' '.$row['nombre2']; ?></a></td>                      
