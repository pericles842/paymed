        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Listado Formas de Pagos</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="../../index.php?usr=1">Home</a></li>
                                <li class="breadcrumb-item active">Listado Formas de Pagos</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
            ...
            <section class="content">
                <div align="center" class="col-md-12">
                    ...
                    <boton class="buttonr"><a style="color: #FFFFFF;font-family: 'Lato', sans-serif;font-size: 18px;font-weight: bold;" href="regformapago.php">Añadir</a></boton>
                    <!--/form-->
                </div><br>
                <!-- Default box -->
                <div class="card">
                                ...
                                <?php while ($row = mysqli_fetch_array($result)) { ?>
                                    <tr>
                                        ...
                                        <td class="project-actions ">
                                            <a class="btn btn-info btn-sm" href="upd_formapago.php?idfpgo=<?php echo $row['idforpag']; ?>"><i class="fas fa-pencil-alt"></i> Editar</a>
                                            <a class="btn btn-danger btn-sm" href="src_del_formapago.php?idfpgo=<?php echo $row['idforpag']; ?>"><i class="fas fa-trash"></i> Eliminar</a>
                                        </td>
