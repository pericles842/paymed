...
if (isset($_POST['submit'])) {
   ...
   $str = "UPDATE tipocuenta SET tipocuenta='" . ucfirst($tipocuenta) . "', idestatus='" . $estatus . "' 
          WHERE idtipocuenta = '" . $idtc . "'";
   $conexion = $mysqli->query($str);

   echo '<script language="javascript">alert("Actualizacion Exitosa!!!");
                                        window.location.href="rpt_tipocuenta.php"; </script>';
}
?>
<!DOCTYPE html>
<html>
               ...
               <div class="row mb-2">
                  ...
                  <div class="col-sm-6">
                     <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Actualizacion de Cuenta</li>
                     </ol>
                  </div>
               </div>
            </div><!-- /.container-fluid -->
        ...
        <div class="col-md-12"-->
            <div class="card card-primary">
               <div style="background: #F89921" class="card-header">
                  <h3 class="card-title">Actualizacion de Cuenta</h3>
                     ...
                     <div class="row">
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" value="<?php echo $roww['tipocuenta']; ?>" name="tipocuenta" class="form-control">
                           </div>
                        </div>
                        <div class="col-md-6">
                           <div class="form-group">
