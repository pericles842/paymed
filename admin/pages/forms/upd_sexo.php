...
if (isset($_POST['submit'])) {
   ...
   $str = "UPDATE sexo SET sexo='" . ucfirst($sexo) . "', idestatus='" . $estatus . "' 
          WHERE idsexo= '" . $idsex . "'";
   $conexion = $mysqli->query($str);

   echo '<script language="javascript">alert("Actualizacion Exitosa!!!");
                                        window.location.href="rpt_sexo.php"; </script>';
}
?>
<!DOCTYPE html>
<html>
               ...
               <div class="row mb-2">
                  ...
                  <div class="col-sm-6">
                     <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Actualizacion de Sexo</li>
                     </ol>
                  </div>
               </div>
            </div><!-- /.container-fluid -->
        ...
        <div class="col-md-12"-->
            <div class="card card-primary">
               <div style="background: #F89921" class="card-header">
                  <h3 class="card-title">Actualizacion de Sexo</h3>
                     ...
                     <div class="row">
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" value="<?php echo $roww['sexo']; ?>" name="sexo" class="form-control">
                           </div>
                        </div>
                        <div class="col-md-6">
                           <div class="form-group">
