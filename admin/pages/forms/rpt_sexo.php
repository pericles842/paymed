              ...
              <tbody>
                  ...
                  <tr>
                      ...
                      <td class="project-actions text-right">
						            <a class="btn btn-info btn-sm" href="upd_sexo.php?idsex=<?php echo $row['idsexo'];?>"><i class="fas fa-pencil-alt"></i> Editar</a>
                        <a class="btn btn-danger btn-sm" href="src_del_sexo.php?idsex=<?php echo $row['idsexo'];?>"><i class="fas fa-trash"></i> Eliminar</a>
                      </td>
