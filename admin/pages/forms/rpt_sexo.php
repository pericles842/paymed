        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Listado de Sexo</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
  ...
  <section class="content">
			<div align="center" class="col-md-12">
				<!--form action="reguser.php" method="POST"-->
					...
					<boton class="buttonr"><a style="color: #FFFFFF;font-family: 'Lato', sans-serif;font-size: 18px;font-weight: bold;" href="regsexo.php">Añadir</a></boton>
				<!--/form-->
			</div><br>
      <!-- Default box -->
      <div class="card">
