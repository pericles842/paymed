...
$idespm = $_GET['idespm'];
$sql = ("SELECT * FROM especialidadmed WHERE idespmed = '" . $idespm . "'");
...
if (isset($_POST['submit'])) {
    ...
    $str = "UPDATE especialidadmed SET especialidad='" . ucfirst($especialidad) . "', idestatus='" . $estatus . "' 
          WHERE idespmed = '" . $idespm . "'";
