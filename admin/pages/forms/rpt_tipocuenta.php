      ...
      <div class="content-wrapper">
         ...
         <div class="container">
            <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
               <div class="d-f">
                  <input class="filter" placeholder="Buscar ..." type="text">
                  <button class=" fa fa-search search"  name="search"></button>
               </div>
               <div class="btn-group" role="group">
                  <button id="btnGroupDrop1"  class="fa fa-bars group" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></button>
